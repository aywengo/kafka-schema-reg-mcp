...
async def main():
    ...
    parser.add_argument("--url", required=True, help="Remote MCP server URL (e.g., https://mcp-schema-registry.your-domain.com/mcp)")
    parser.add_argument("--auth-token", help="OAuth JWT token or development token (e.g., dev-token-read)")
