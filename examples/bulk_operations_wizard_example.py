    ...
    mock_flow = [
        {
            ...
            "user_selects": "Cleanup"
        },
        {
            "step": 2,
            "prompt": "What type of cleanup?",
            "user_selects": "Test schemas"
        },
        {
            "step": 3,
            "prompt": "Select schemas to clean up",
            "user_selects": ["test-*", "temp-*"]
        },
        {
            "step": 4,
        ...
        {
            "step": 5,
            "prompt": "This will affect 23 schemas. Preview changes?",
            "user_selects": "Yes"
        },
        {
            "step": 6,
...
async def example_error_handling():
    ...
    # Configure with rollback enabled
    config = BulkOperationConfig(
