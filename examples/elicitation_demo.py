...
class ElicitationDemo:
    ...
    async def demo_migration_preferences(self) -> Dict[str, Any]:
        ...
        print("\n🤔 Elicitation would ask for:")
        questions = [
            ("Preserve Schema IDs", "preserve_ids", "Keep original schema IDs during migration?"),
            ("Migrate All Versions", "migrate_all_versions", "Include all schema versions or just latest?"),
            ("Conflict Resolution", "conflict_resolution", "How to handle conflicts? (skip/overwrite/merge/prompt)"),
