...
Kafka cluster name
*/}}
{{- define "kafka-cluster.kafkaName" -}}
{{- .Values.kafka.name | default (include "kafka-cluster.fullname" .) }}
{{- end }}

{{/*
ConfigMap name for metrics
*/}}
{{- define "kafka-cluster.metricsConfigMapName" -}}
{{- printf "%s-metrics" (include "kafka-cluster.kafkaName" .) }}
{{- end }} 