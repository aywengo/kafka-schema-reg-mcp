...
class RegistryClient:
    ...
    def register_schema(self, subject: str, schema_definition: Dict[str, Any], 
                       schema_type: str = "AVRO", context: Optional[str] = None) -> Dict[str, Any]:
    ...
    def update_global_config(self, compatibility: str, context: Optional[str] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            response = requests.put(url, data=json.dumps(payload), auth=self.auth, headers=self.standard_headers)
            response.raise_for_status()
            result = response.json()
            result["registry"] = self.config.name
            return result
    ...
    def check_compatibility(self, subject: str, schema_definition: Dict[str, Any], 
                          schema_type: str = "AVRO", context: Optional[str] = None) -> Dict[str, Any]:
...
def check_readonly_mode(registry_manager: BaseRegistryManager, registry_name: Optional[str] = None) -> Optional[Dict[str, str]]:
...
def get_default_client(registry_manager: BaseRegistryManager) -> Optional[RegistryClient]:
...
def get_schema_with_metadata(client: RegistryClient, subject: str, version: str, context: Optional[str] = None) -> Dict[str, Any]:
...
def export_schema(client: RegistryClient, subject: str, version: str = "latest", 
                 context: Optional[str] = None, format: str = "json") -> Union[Dict[str, Any], str]:
...
def export_subject(client: RegistryClient, subject: str, context: Optional[str] = None,
                  include_metadata: bool = True, include_config: bool = True, 
                  include_versions: str = "all") -> Dict[str, Any]:
...
def export_context(client: RegistryClient, context: str, include_metadata: bool = True,
                  include_config: bool = True, include_versions: str = "all") -> Dict[str, Any]:
...
def export_global(client: RegistryClient, include_metadata: bool = True,
                 include_config: bool = True, include_versions: str = "all") -> Dict[str, Any]:
...
def clear_context_batch(client: RegistryClient, context: str, delete_context_after: bool = True, 
                       dry_run: bool = True, registry_name: str = "default") -> Dict[str, Any]:
            ...
            def delete_single_subject(subject):
                try:
                    ...
                    if success:
                        ...
                        return {"subject": subject, "status": "failed", "error": "Delete failed"}
                except Exception as e:
