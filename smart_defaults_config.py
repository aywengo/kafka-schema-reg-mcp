...
class SmartDefaultsConfig:
    ...
    # Learning settings
    learning_storage_path: Path = field(
        default_factory=lambda: Path.home() / '.kafka-schema-mcp' / 'smart_defaults'
    )
    ...
    environment_defaults: Dict[str, Dict[str, Any]] = field(default_factory=lambda: {
        "production": {
            "compatibility": "FULL",
            "dry_run": True,
            "preserve_ids": True
