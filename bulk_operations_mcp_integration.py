...
from bulk_operations_wizard import BulkOperationsWizard, BulkOperationType, BulkOperationConfig
...
def create_bulk_operations_tools(wizard: BulkOperationsWizard) -> List[Tool]:
    ...
    tools.append(Tool(
        ...
        inputSchema={
            ...
            "properties": {
                "pattern": {
                    "type": "string",
                    "description": "Schema name pattern (e.g., 'test-*', 'prod-*')"
                },
                "update_type": {
                    "type": "string",
    ...
    tools.append(Tool(
        ...
        inputSchema={
            ...
            "properties": {
                "source_context": {
                    "type": "string",
                    "description": "Source context (default: current context)"
                },
                "target_context": {
                    "type": "string",
                    "description": "Target context for migration"
                },
                "source_registry": {
                    "type": "string",
                ...
                "schema_pattern": {
                    "type": "string",
                    "description": "Pattern to match schemas for migration"
                },
                "preserve_ids": {
                    "type": "boolean",
                    "default": True,
    ...
    tools.append(Tool(
        ...
        inputSchema={
            ...
            "properties": {
                ...
                "pattern": {
                    "type": "string",
                    "description": "Pattern to match targets (for schemas/contexts)"
                },
                "settings": {
                    "type": "object",
    ...
    tools.append(Tool(
        ...
        inputSchema={
            ...
            "properties": {
                "task_id": {
                    "type": "string",
                    "description": "Task ID returned by bulk operation"
                }
            },
            "required": ["task_id"]
        }
    ...
    tools.append(Tool(
        ...
        description=(
            ...
            "Will attempt to rollback any changes made if rollback is enabled."
        ),
        inputSchema={
            "type": "object",
            "properties": {
                "task_id": {
                    "type": "string",
                    "description": "Task ID of operation to cancel"
                },
                "rollback": {
                    "type": "boolean",
                    "default": True,
                    "description": "Attempt to rollback changes"
                }
            },
            "required": ["task_id"]
        }
...
async def handle_bulk_operations_tool(
    ...
    if tool_name == "bulk_operations_wizard":
        ...
        config = BulkOperationConfig(
            operation_type=BulkOperationType.SCHEMA_UPDATE,
        ...
        config = BulkOperationConfig(
            operation_type=BulkOperationType.CLEANUP,
            dry_run=not arguments.get("force", False)
        )
        ...
        config = BulkOperationConfig(
            operation_type=BulkOperationType.CONFIGURATION,
            dry_run=arguments.get("dry_run", True)
        )
