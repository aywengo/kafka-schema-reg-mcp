...
class TestRegistryURI(unittest.TestCase):
    ...
    def test_registry_name_sanitization(self):
        ...
        self.assertEqual(uri_builder.registry_name, "registry-with-special-chars")
...
class TestResourceLinker(unittest.TestCase):
    ...
    def test_migration_links(self):
        ...
        self.assertEqual(links["source_registry"], "registry://source-reg")
...
class TestUtilityFunctions(unittest.TestCase):
    ...
    def test_extract_registry_from_uri(self):
        ...
        self.assertEqual(extract_registry_from_uri("registry://my-reg"), "my-reg")
    ...
    def test_parse_registry_uri(self):
        ...
        expected = {"registry": "test-reg", "migration_id": "mig-123"}

        self.assertEqual(parsed, expected)

    def test_add_links_to_response(self):
        """Test the generic add_links_to_response function."""
        response = {"id": 123, "version": 3, "schema": {"type": "record"}}
...
class TestResourceLinkingIntegration(unittest.TestCase):
    ...
    def test_error_handling(self):
        ...
        response = {"test": "data"}
        enhanced = add_links_to_response(response, "invalid_type", "test-registry")
