...
class TestMCPContainerIntegration:
    ...
    def test_schema_registration_and_retrieval(self, mcp_client):
        ...
        # Register schema
        result = mcp_client.call_tool("register_schema", {
            "subject": subject,
        ...
        # Retrieve the schema
        result = mcp_client.call_tool("get_schema", {
            "subject": subject,
            "version": "latest"
        })
        ...
        # List versions
        result = mcp_client.call_tool("get_schema_versions", {
            "subject": subject
        })
    ...
    def test_schema_comparison(self, mcp_client):
        ...
        mcp_client.call_tool("register_schema", {
        ...
        # Compare schemas
        result = mcp_client.call_tool("compare_schemas", {
    ...
    def test_error_handling(self, mcp_client):
        ...
        with pytest.raises(RuntimeError) as exc_info:
            mcp_client.call_tool("get_schema", {
    ...
    def test_container_restart_recovery(self):
        ...
        result = new_client.call_tool("get_schema", {
            "subject": subject,
            "version": "latest"
        })
