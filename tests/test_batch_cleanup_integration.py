...
class TestBatchCleanupIntegration:
            ...
            try:
                ...
                for registry_url in [cls.dev_url, cls.prod_url]:
                    ...
                    subjects_response = requests.get(
                        f"{registry_url}/contexts/{context}/subjects",
                        timeout=5
                    )
    ...
    def test_readonly_mode_protection(self):
        ...
        try:
            ...
            assert "readonly_mode" in delete_result or "READONLY" in str(delete_result), "Should block deletion in READONLY mode"
    ...
    def test_partial_failure_handling(self):
        ...
        assert "successful_deletions" in str(cleanup_result) or cleanup_result["subjects_deleted"] >= 0, "Should track deletion results"
    ...
    def test_concurrent_cleanup_operations(self):
        ...
        def cleanup_context(context):
            return single_mcp.clear_context_batch(
                context=context,
                dry_run=False
            )
    ...
    def test_comprehensive_reporting_metrics(self):
        ...
        required_fields = [
            "context", "dry_run", "started_at", "completed_at", "duration_seconds",
            "subjects_found", "subjects_deleted", "subjects_failed", "context_deleted",
            "success_rate", "deleted_subjects", "failed_deletions", "performance", "message"
        ]
        ...
        performance_fields = ["subjects_per_second", "parallel_execution", "max_concurrent_deletions"]
