...
from schema_definitions import get_tool_schema, ERROR_RESPONSE_SCHEMA
...
class SchemaValidationError(Exception):
    ...
    def __init__(self, message: str, validation_error: Optional[Exception] = None, data: Optional[Any] = None):
                ...
                if fallback_on_error:
                    ...
                    if isinstance(result, dict):
                        result["_validation"] = {
                            ...
                            "warnings": validation_result.warnings + ["Validation failed - returning unstructured data"]
                        }
                    return result
                else:
...
def check_schema_compatibility() -> Dict[str, Any]:
    ...
    return {
        ...
        "recommendations": [
            "Install jsonschema library for full validation support" if not JSONSCHEMA_AVAILABLE else "Schema validation fully supported"
        ]
    }
...
def create_success_response(message: str, data: Optional[Dict[str, Any]] = None, 
                          registry_mode: str = "unknown") -> Dict[str, Any]:
...
def create_error_response(error: str, details: Optional[Dict[str, Any]] = None,
